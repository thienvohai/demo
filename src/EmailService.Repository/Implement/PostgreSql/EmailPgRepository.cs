...
public class EmailPgRepository : BasePgRepository, IEmailRepository
{
    ...
    public async Task<int> UpdateSentEmail(EmailEntity emailEntity)
    {
        ...
        parameter.Add("@id", emailEntity.Id);
        parameter.Add("@modified", DateTime.UtcNow, DbType.DateTime);
    ...
    public async Task<int> UpdateFailedEmail(EmailEntity emailEntity)
    {
        ...
        parameter.Add("@nextRetry", emailEntity.NextRetryTime, DbType.DateTime);
        parameter.Add("@id", emailEntity.Id);
        parameter.Add("@modified", DateTime.UtcNow, DbType.DateTime);
        parameter.Add("@false", false);
        var query = $@"UPDATE ""{Schema}"".""{TableNames.EmailTable}""
    ...
    {
        var parameter = new DynamicParameters();
        parameter.Add("@true", true);
        parameter.Add($"@emailId", emailEntity.Id);
        parameter.Add($"@modified", emailEntity.Modified, DbType.DateTime);
    ...
    {
        var parameter = new DynamicParameters();
        parameter.Add("@before", before, DbType.DateTime);
